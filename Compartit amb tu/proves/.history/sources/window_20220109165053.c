...
void destroy_all(t_var *var)
{
    ...
    sfSprite_destroy(var->SpriteBack);
    //sfSprite_destroy(var->sprite_background2);
    //sfSprite_destroy(var->sprite_background3);
    //sfSprite_destroy(var->sprite_gover);
    //sfSprite_destroy(var->Spritelevel);
    //sfSprite_destroy(var->Spritebuttonlevel1);
    //sfSprite_destroy(var->Spritebuttonlevel2);
    //sfSprite_destroy(var->Spritebutlevel3);
    //sfSprite_destroy(var->sprite_bend);
    //sfSprite_destroy(Spritebutlevel3);
}
