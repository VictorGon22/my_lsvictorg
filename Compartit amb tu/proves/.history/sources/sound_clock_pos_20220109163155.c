...
{
    var -> buffer = sfSoundBuffer_createFromFile("./sound/jumpsound.wav");
    var -> sound_jump = sfSound_create();
    sfSound_setBuffer(var -> sound_jump, var -> buffer);
    var -> buffer = sfSoundBuffer_createFromFile("./deadsound.wav");
    var -> sound_dead = sfSound_create();
    sfSound_setBuffer(var -> sound_dead, var -> buffer);
    var -> buffer = sfSoundBuffer_createFromFile("./touched.wav");
