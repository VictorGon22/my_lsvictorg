...
{
    sfTexture *texture_expl = sfTexture_createFromFile
    ("./images/explosion.png", NULL);
    sfSprite *sprite_expl = sfSprite_create();
    sfSprite_setTexture (sprite_expl, texture_expl, 0);
    return (sprite_expl);
}
